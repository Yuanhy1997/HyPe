...
class BertLayer(nn.Module):
    ...
    def add_noise(self, noi_type, eps):

        self.noise_eps = eps
        self.noise_type = noi_type
...
class BertEncoder(nn.Module):
    ...
    def add_noise_sampler(self, eps, noise_type, add_intermediate = False, only_intermediate = False, layer_range = None):
        ...
        if add_intermediate:
            for layer in self.layer:
                layer.add_noise(self.noise_type, self.noise_eps)
...
class BertForSequenceClassification_HyPe(BertForSequenceClassification):
